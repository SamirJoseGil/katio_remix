    ...
    return (
        <footer className="footer bg-neutral text-base-content p-10">
            ...
            <nav>
                ...
                <a className="link link-hover" href="/books">Libros</a>
                <a className="link link-hover" href="/autors">Autores</a>
                <a className="link link-hover" href="/audiobooks">Audio libros</a>
                <a className="link link-hover" href="/narrators">Narradores</a>
            </nav>
            <nav>
            ...
            <nav>
                ...
                <div className="grid grid-flow-col gap-4">
                    ...
                    <a href="https://www.youtube.com/c/Fundaci%C3%B3nSecretosparaContar" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                    ...
                    <a href="https://web.facebook.com/secretosparacontar" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
